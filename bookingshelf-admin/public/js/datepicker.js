(function(window, $, undefined) {
  ;(function() {
    ...
    datepicker.prototype = {
      ...
      formatDate: function(string, date, locale=this.loc) {
        date = date || this.date;
        let result = string;
        const boundary = this._getWordBoundaryRegExp;
        // locale = this.loc,
      ...
      selectDate: function(date) {
        ...
        const selectedDates = _this.selectedDates;
      ...
      update: function(param, value) {
        ...
        const lastSelectedDate = this.lastSelectedDate;
      ...
      _setInputValue: function() {
        ...
        let value = _this.selectedDates.map(function(date) {
        ...
        this.$el.attr('minDate', this.selectedDates[0]);
        this.selectedDates[1]&&this.$el.attr('maxDate', this.selectedDates[1]);
      },
      ...
      _registerKey: function(key) {
        const exists = this.keys.some(function(curKey) {
          return curKey == key;
        });
