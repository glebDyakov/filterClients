function initializeJs() {
    ...
    $('.select_add_new_hours').change(function () {
        var selnum = $('option:selected', this).val();
        var selectadd = $(this).parent('div').parent('.selects-block').children('.add-block').html();
    ...
    $('.chose_button .button-color').click(function () {
        ...
        var cbutton = $('span', this).css('background-color');
