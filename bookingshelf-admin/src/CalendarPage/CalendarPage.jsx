    ...
    selectType (type){
        ...
        if(type==='day') {
            ...
            this.props.dispatch(calendarActions.getReservedTime(moment(weeks[0]).startOf('day').format('x'),
                ...
                history.pushState(null, '', '/calendar/staff/'+JSON.parse(selectedStaff && selectedStaff.availableDays.length ? selectedStaff : JSON.stringify(staffAll.availableTimetable[0])).staffId+'/'+moment(weeks[0]).format('DD-MM-YYYY')+"/"+moment(weeks[6]).format('DD-MM-YYYY'));
