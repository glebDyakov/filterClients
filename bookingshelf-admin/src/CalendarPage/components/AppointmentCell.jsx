...
class AppointmentCell extends PureComponent {


    render() {
        const {appointment, appointments,workingStaffElement, handleUpdateClient, approveAppointmentSetter,currentTime,key,client} = this.props;
