...
class TabScroll extends PureComponent{
    ...
    render(){
        const {numbers, availableTimetable,selectedDays, closedDates, client, appointments,reservedTime,handleUpdateClient, approveAppointmentSetter,updateReservedId,changeTime } = this.props;
