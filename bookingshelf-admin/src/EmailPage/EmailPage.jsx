...
import {notificationActions, servicesActions} from "../_actions";
...
class EmailPage extends Component {
    ...
    setTab(tab){
        ...
        if(tab==='newsletter'){document.title = "Рассылка | Онлайн-запись"}
    ...
    handleChangeEmailtoggle (type) {
        ...
        this.setState({...this.state, email: {...email, [type]: !email[type]}});
    }
    ...
    handleChangeSMS_text(e) {
        ...
        this.setState({...this.state, sms: {...sms, [name]: value}, count_sms: count_sms});
    }
    ...
    render() {
        const {notification, activeTab, services, serviceCurrent, sms, notifications, count_sms}=this.state
                                            ...
                                            <div className="tab-content content-pages-bg">
                                                ...
                                                <div className={"tab-pane"+(activeTab==='smsletter'?' active':'')} id="sms_tab1">
                                                    <div className="block-style1  pl-4 pr-4">
                                                        ...
                                                        <button type="submit"
                                                                className={"button float-right mob-hiden "+((sms.title==='' || sms.description==='' || (!sms.toClients && !sms.toStaffs) || sms.serviceId===0) && ' disabledField')} onClick={()=>sms.title!=='' && sms.description!=='' && (sms.toClients || sms.toStaffs) && sms.serviceId!==0 && this.setSMS()}>Начать рассылку
                                                        </button>
                                                    </div>
                                                    <div className="block-style2 container ">
                                                        ...
                                                        <button type="submit"
                                                                className={"button float-right mob-fade "+((sms.title==='' || sms.description==='' || (!sms.toClients && !sms.toStaffs) || sms.serviceId===0) && ' disabledField')} onClick={()=>sms.title!=='' && sms.description!=='' && (sms.toClients || sms.toStaffs) && sms.serviceId!==0 && this.setSMS()}>Начать рассылку
                                                        </button>
                                                    </div>
                                                ...
                                                <div className={"tab-pane"+(activeTab==='newsletter'?' active':'')} id="sms_tab1">
                                                    <div className="block-style1  pl-4 pr-4">
                                                        ...
                                                        <button type="submit"
                                                                className="button float-right mob-hiden">Начать
                                                            рассылку
                                                        </button>
                                                    </div>
                                                    <div className="block-style2 container ">
                                                            ...
                                                            <div className="check-box">
                                                                <div className="form-check-inline row">
                                                                    <input type="radio" className="form-check-input"
                                                                           name="group13" id="radio21203"/>
                                                                    <label className="form-check-label col-6"
                                                                           htmlFor="radio2203">Все
                                                                        клиенты</label>
                                                                </div>
                                                            </div>
                                                            <div className="check-box">
                                                                <div className="form-check-inline row">
                                                                    ...
                                                                    <input type="radio" className="form-check-input"
                                                                           name="group13" id="radio2713"/>
                                                                    <label className="form-check-label col-6"
                                                                           htmlFor="radio273">Все
                                                                        сотрудники
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            <p className="mb-2 mt-3">Выбрать услугу</p>
                                                            <div className="select-color mb-3 dropdown border-color">
                                                                {serviceCurrent && serviceCurrent.id !== -1 ?
                                                                    <a className={serviceCurrent.service.color.toLowerCase() + " " + 'select-button dropdown-toggle'}
                                                                       data-toggle={"dropdown"} href="#"><span
                                                        ...
                                                        <button type="submit"
                                                                className="button float-right mob-fade">Начать рассылку
                                                        </button>
                                                    </div>
                                                    <span className="clearfix"></span>
                                                </div>
...
function mapStateToProps(store) {
    const {notification, services}=store;
