                                        ...
                                        <div className="tab-content content-pages-bg">
                                            ...
                                            <div className={"tab-pane"+(activeTab==='smsletter'?' active':'')} id="sms_tab1">
                                                <div className="block-style1  pl-4 pr-4">
                                                    ...
                                                    <button type="submit"
                                                            className={"button float-right mob-hiden "+((sms.title==='' || sms.description==='' || (!sms.toClients && !sms.toStaffs)) && ' disabledField')} data-toggle="modal" data-target={sms.title!=='' && sms.description!=='' && (sms.toClients || sms.toStaffs) && '.start-modal-sms'}>Сформировать рассылку
                                                    </button>
                                                </div>
                                                <div className="block-style2 container ">
                                                    ...
                                                    <button type="submit"
                                                            className={"button float-right mob-fade "+((sms.title==='' || sms.description==='' || (!sms.toClients && !sms.toStaffs)) && ' disabledField')}  data-toggle="modal" data-target={sms.title!=='' && sms.description!=='' && (sms.toClients || sms.toStaffs) && '.start-modal-sms'}>Сформировать рассылку
                                                    </button>
                                                </div>
