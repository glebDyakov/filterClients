                ...
                <div className={'tab-pane' + (activeTab === 'smsletter' ? ' active' : '')}
                  ...
                  <div className="block-style1">
                    ...
                    <p className="count-letters">
                      Количество смс: {count_sms}, количество символов: {sms.description.length}
                    </p>
                    ...
                    <div className="row">
                      <div className="col-6 col-md-3">
                        <p className="count-sms">
                          Количество SMS: {notification.balance && notification.balance.smsAmount}
                        </p>

                      </div>
                      <div className="col-6 col-md-3">
                        <p className="count-email">
                          Количество Email: {notification.balance && notification.balance.emailAmount}
                        </p>
                      </div>
