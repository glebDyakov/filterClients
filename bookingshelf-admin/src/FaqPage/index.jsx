...
class Index extends Component {
  constructor(props) {
    ...
    if (props.match.params.activeTab==='email_sms') {
      document.title = 'Вопросы по Email и SMS | Онлайн-запись';
    }
    if (props.match.params.activeTab==='system') {
      document.title = 'Вопросы по журналу записи | Онлайн-запись';
    }
    if (props.match.params.activeTab==='staff') {
      document.title = 'Вопросы по сотрудникам | Онлайн-запись';
    }
