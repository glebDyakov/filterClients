...
import { AddProduct, AddCategory, AddProvider, AddBrand } from "../_components/modals";
...
class Index extends Component {
    ...
    render() {
        ...
        const { product_working, category_working, supplier_working, brand_working, productOpen, providerOpen, categoryOpen, brandOpen, emailNew, emailIsValid, feedbackStaff, staff_working, edit, closedDates, timetableFrom, timetableTo, currentStaff, date, editing_object, editWorkingHours, hoverRange, selectedDays, opacity, activeTab, addWorkTime, newStaffByMail, newStaff } = this.state;
