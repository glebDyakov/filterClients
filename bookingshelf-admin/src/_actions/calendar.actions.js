...
function addAppointment(params, serviceId, staffId, clientId, time1, time2, coStaffs) {
  ...
  function request(appointment) {
    return { type: calendarConstants.ADD_APPOINTMENT_REQUEST, appointment, isLoading: false };
  }
  function success(appointment, staffId) {
    return { type: calendarConstants.ADD_APPOINTMENT_SUCCESS, appointment, staffId };
  }
  function successTime(id) {
    return { type: calendarConstants.ADD_APPOINTMENT_SUCCESS_TIME, id };
  }
  function failure(error) {
    return { type: calendarConstants.ADD_APPOINTMENT_FAILURE, error };
  }
}
...
function makeVisualMove(movingVisit, movingVisitStaffId, movingVisitMillis, coStaffs) {
  return (dispatch) => {
    ...
    function success() {
      return { type: calendarConstants.MAKE_VISUAL_MOVE, movingVisit, movingVisitStaffId, movingVisitMillis, coStaffs };
    }
  };
}
...
function editCalendarAppointment(params, mainAppointmentId, staffId, clientId, withoutNotify) {
    ...
    calendarService.editCalendarAppointment(params, mainAppointmentId, staffId, clientId, withoutNotify)
      .then(
        (appointment) => {
          ...
          // moment().startOf('day').format('x'), moment().add(7, 'month').endOf('month').format('x'))
          // );
  ...
  function request(appointment) {
    return { type: calendarConstants.EDIT_CALENDAR_APPOINTMENT_REQUEST };
  }
  function success(appointment, staffId) {
    return { type: calendarConstants.EDIT_CALENDAR_APPOINTMENT_SUCCESS, appointment, staffId };
  }
  function successTime(id) {
    return { type: calendarConstants.ADD_APPOINTMENT_SUCCESS_TIME, id };
  }
  function failure(error) {
    return { type: calendarConstants.EDIT_CALENDAR_APPOINTMENT_FAILURE, error };
  }
}
...
function setScrollableAppointment(id) {
  ...
  function success(id) {
    return { type: calendarConstants.SET_SCROLLABLE_APPOINTMENT, id };
  }
}
...
function addReservedTime(params, staffId) {
  ...
  function request(reservedTime) {
    return { type: calendarConstants.ADD_RESERVED_TIME_REQUEST, reservedTime };
  }
  function success(reservedTime, staffId) {
    return { type: calendarConstants.ADD_RESERVED_TIME_SUCCESS, reservedTime, staffId };
  }
  function failure(error) {
    return { type: calendarConstants.ADD_RESERVED_TIME_FAILURE, error };
  }
}
...
function editAppointment(params) {
  ...
  function success(appointment) {
    return { type: calendarConstants.EDIT_APPOINTMENT_SUCCESS, appointment };
  }
  function failure(error) {
    return { type: calendarConstants.EDIT_APPOINTMENT_FAILURE, error };
  }
}
...
function editAppointment2(params, id) {
  ...
  function request() {
    return { type: calendarConstants.EDIT_APPOINTMENT_2_REQUEST };
  }
  function success(appointment) {
    return { type: calendarConstants.EDIT_APPOINTMENT_2_SUCCESS, appointment };
  }
  function successTime(id) {
    return { type: calendarConstants.ADD_RESERVED_TIME_SUCCESS_TIME, id };
  }
  function failure(error) {
...
function updateAppointment(id, params, withoutNotify, isAppointmentUpdated) {
  ...
  function request() {
    return { type: calendarConstants.UPDATE_APPOINTMENT };
  }

  function success() {
    return { type: calendarConstants.UPDATE_APPOINTMENT_SUCCESS, isAppointmentUpdated };
  }
  function failure(error) {
    return { type: calendarConstants.UPDATE_APPOINTMENT_FAILURE, error };
  }
  function returnVisualVisit() {
    return { type: calendarConstants.CANCEL_VISUAL_MOVE };
  }
  function clearVisualVisit() {
    return { type: calendarConstants.CLEAR_VISUAL_MOVE };
  }
}
...
function updateAppointmentCheckbox(id, params, withoutNotify) {
  ...
  function request() {
    return { type: calendarConstants.UPDATE_APPOINTMENT_CHECKBOX };
  }
  function success(appointment) {
    return { type: calendarConstants.UPDATE_APPOINTMENT_CHECKBOX_SUCCESS, appointment };
  }
  function failure(error) {
    return { type: calendarConstants.UPDATE_APPOINTMENT_CHECKBOX_FAILURE, error };
  }
}
...
function updateAppointmentFinish(id, params) {
  ...
  function success() {
    return { type: calendarConstants.UPDATE_APPOINTMENT_SUCCESS, isAppointmentUpdated: false };
  }
...
function getAppointments(dateFrom, dateTo, isLoading = true) {
  const normalViewTime = moment(parseInt(dateFrom)).format('hh:ss');
  ...
  function request(isLoading) {
    return { type: calendarConstants.GET_APPOINTMENT_REQUEST, isLoading };
  }
  function success(appointments) {
    return { type: calendarConstants.GET_APPOINTMENT_SUCCESS, appointments };
  }
  function failure() {
    return { type: calendarConstants.GET_APPOINTMENT_FAILURE };
  }
}
...
function getAppointmentsCount(dateFrom, dateTo) {
  ...
  function request() {
    return { type: calendarConstants.GET_APPOINTMENT_REQUEST_COUNT };
  }
  function success(appointments) {
    return { type: calendarConstants.GET_APPOINTMENT_SUCCESS_COUNT, appointments };
  }
  function failure() {
    return { type: calendarConstants.GET_APPOINTMENT_FAILURE_COUNT };
  }
}
...
function getAppointmentsCanceled(dateFrom, dateTo) {
  ...
  function request() {
    return { type: calendarConstants.GET_APPOINTMENT_REQUEST__CANCELED };
  }
  function success(appointments) {
    return { type: calendarConstants.GET_APPOINTMENT_SUCCESS_CANCELED, appointments };
  }
  function failure() {
    return { type: calendarConstants.GET_APPOINTMENT_FAILURE__CANCELED };
  }
}
...
function getReservedTime(dateFrom, dateTo) {
  ...
  function request() {
    return { type: calendarConstants.GET_RESERVED_TIME_REQUEST };
  }
  function success(reservedTime) {
    return { type: calendarConstants.GET_RESERVED_TIME_SUCCESS, reservedTime };
  }
  function failure() {
    return { type: calendarConstants.GET_RESERVED_TIME_FAILURE };
  }
}
...
function deleteAppointment(appointment, withoutNotify, propogate, nextUpdatingData) {
  ...
  // function request() {
  //   return { type: calendarConstants.DELETE_APPOINTMENT };
  // }
  function success() {
    return { type: calendarConstants.DELETE_APPOINTMENT_SUCCESS };
  }
  function failure(error) {
    return { type: calendarConstants.DELETE_APPOINTMENT_FAILURE, error };
  }
  function makeVisualDeleting(error) {
    return { type: calendarConstants.MAKE_VISUAL_DELETING, appointment };
  }
  function cancelVisualDeleting(error) {
    return { type: calendarConstants.CANCEL_VISUAL_DELETING, appointment };
  }
  function clearVisualDeleting(error) {
    return { type: calendarConstants.CLEAR_VISUAL_DELETING, appointment };
  }
}
...
function deleteReservedTime(id, reservedTimeId) {
  ...
  function success(reservedTimeId) {
    return { type: calendarConstants.DELETE_RESERVED_TIME_SUCCESS, reservedTimeId };
  }
  function failure(error) {
    return { type: calendarConstants.DELETE_RESERVED_TIME_FAILURE, error };
  }
}
...
function approveAppointment(id, params) {
        ...
        (client) => {
          ...
          dispatch(
            calendarActions.getAppointmentsCount(
              ...
              moment().add(7, 'month').endOf('month').format('x'),
            ),
          );
        },
  ...
  function success(id) {
    return { type: calendarConstants.APPROVE_APPOINTMENT_SUCCESS, id };
  }
  function failure(error) {
    return { type: calendarConstants.APPROVE_APPOINTMENT_FAILURE, error };
  }
}
  ...
  return (dispatch) => {
    calendarService.approveAllAppointment(approved, canceled, params)
      .then(
        () => {
          dispatch(companyActions.getNewAppointments());
          dispatch(calendarActions.getAppointmentsCount(
            moment().startOf('day').format('x'),
            moment().add(7, 'month').endOf('month').format('x'),
          ));
          dispatch(calendarActions.getAppointmentsCanceled(
            moment().startOf('day').format('x'),
            moment().add(7, 'month').endOf('month').format('x'),
          ));
        },
...
function addManager(manager) {
  ...
  function request(manager) {
    return { type: calendarConstants.ADD_MANAGER_REQUEST, manager };
  }
  function success(manager, staffId) {
    return { type: calendarConstants.ADD__MANAGER__SUCCESS, manager };
  }
  // function successTime(id) { return { type: calendarConstants.ADD_APPOINTMENT_SUCCESS_TIME, id } }
  function failure(error) {
    return { type: calendarConstants.ADD__MANAGER__FAILURE, error };
  }
}
function sendMessage(message) {
  return (dispatch) => {
    ...
    calendarService.sendMessage(message)
      .then(
        (message) => {
...
function getManagers() {
  ...
  function request() {
    return { type: calendarConstants.GET_MANAGERS };
  }
  function success(managers) {
    return { type: calendarConstants.GET_MANAGERS_SUCCESS, managers };
  }
  function failure() {
