...
function add(companyInfo) {
  ...
  function success(company, menu, profile) {
    return { type: userConstants.UPDATE_COMPANY_SUCCESS, company, menu, profile };
  }
}
...
function updateSaved(saved) {
  ...
  function success() {
    return { type: companyConstants.UPDATE_SAVED, saved };
  }
}
...
function updateCompanySettings(companyInfo, loadingKey, saved) {
  ...
  function request() {
    return { type: companyConstants.UPDATE_COMPANY_SETTINGS_REQUEST, loadingKey };
  }
  function success(company, menu, profile) {
    return { type: companyConstants.UPDATE_COMPANY_SETTINGS_SUCCESS, company, menu, profile, loadingKey, saved };
  }
  function failure(error) {
    return { type: companyConstants.UPDATE_COMPANY_SETTINGS_FAILURE, error, loadingKey };
  }
}
...
function addSubcompany(companyInfo) {
  ...
  function success(company, menu, profile) {
    return { type: companyConstants.ADD_SUBCOMPANY_SUCCESS, company };
  }
}
...
function switchSubcompany(companyInfo) {
  ...
  function success() {
    return { type: companyConstants.SWITCH_SUBCOMPANY_SUCCESS, company: companyInfo, menu, profile };
  }
}
...
function get() {
  ...
  function success(settings) {
    return { type: companyConstants.GET_COMPANY_SUCCESS, settings };
  }
}
...
function getSubcompanies() {
  ...
  function success(subcompanies) {
    return { type: companyConstants.GET_SUBCOMPANIES_SUCCESS, subcompanies };
  }
}
...
function getBookingInfo() {
  ...
  function request() {
    return { type: companyConstants.GET_BOOKING_REQUEST };
  }
  function success(booking) {
    return { type: companyConstants.GET_BOOKING_SUCCESS, booking };
  }
  function failure(error) {
    return { type: companyConstants.GET_BOOKING_FAILURE, error };
  }
}
...
function getNewAppointments() {
  ...
  function success(count) {
    return { type: companyConstants.GET_NEW_APPOINMENTS_SUCCESS, count };
  }
}
...
function updateBookingInfo(params, isBookingInfoLoading) {
  ...
  function request() {
    return { type: companyConstants.UPDATE_BOOKING_INFO_REQUEST, isBookingInfoLoading };
  }
  function success(booking) {
    return { type: companyConstants.UPDATE_BOOKING_INFO_SUCCESS, booking };
  }
  function failure(error) {
    return { type: companyConstants.UPDATE_BOOKING_INFO_FAILURE, error };
  }
}
