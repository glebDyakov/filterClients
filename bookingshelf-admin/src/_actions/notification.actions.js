...
function getSMS_EMAIL() {
  ...
  function success(notification) {
    return { type: notificationConstants.GET_SMS_RECORD_SUCCESS, notification };
  }
}
...
function getBalance() {
  ...
  function success(balance) {
    return { type: notificationConstants.GET_SMS_EMAIL_BALANCE, balance };
  }
}
...
function getHistorySms(currentPage, searchValue) {
  ...
  function success(history) {
    return { type: notificationConstants.GET_HISTORY_SMS_SUCCESS, history };
  }
}
...
function getClientAmount() {
  ...
  function success(info) {
    return { type: notificationConstants.GET_CLIENT_AMOUNT_SUCCESS, info };
  }
}
...
function setSMS(params) {
  ...
  function request(notification) {
    return { type: notificationConstants.SMS_LETTER_REQUEST, notification };
  }
  function success(notification) {
    return { type: notificationConstants.SMS_LETTER_SUCCESS, notification };
  }
  function success_time(notification) {
    return { type: notificationConstants.SMS_LETTER_SUCCESS_TIME, notification };
  }
}
