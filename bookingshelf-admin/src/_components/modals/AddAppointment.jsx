...
class AddAppointment extends React.Component {
  ...
  addNewService() {
    ...
    let appointmentMessage = this.props.t(
      "Невозможно добавить ещё одну услугу"
    );
  ...
  removeService(index) {
    ...
    if (index === 0 && appointment.length !== 1) {
      ...
      appointment.forEach((item, localIndex) => {
        if (localIndex > 0) {
          item.appointmentTimeMillis =
            item.appointmentTimeMillis - appointment[0].duration * 1000;
        }
  ...
  getServiceList(index) {
                    ...
                    >
                      ...
                      >
                        <span
                          ...
                          style={service.grey ? { opacity: "0.4" } : {}}
                        >
                          ...
                          <span className="right-block">
                            ...
                            <span className="timing">
                              {moment
                                ...
                                .format(
                                  `h[ ${this.props.t("ч")}] m[ ${this.props.t(
                                    "минут"
                                  )}]`
                                )}
                              &nbsp;|
    ...
    if (filteredServiceListWithoutTime.length) {
      return (
        <p className="staffAlert-noService">
          {this.props.t("Нет доступных услуг в выбранный диапазон времени")}
        </p>
      );
    }
    ...
    return (
      <p className="staffAlert-noService">
        {this.props.t(
          "Нет доступных услуг. Выберите сотрудника в настройках услуг"
        )}
      </p>
    );
  }
        ...
        <div className="row">
          ...
          >
            <span className="add-helpers-text">
              {this.props.t("Добавить помощников")}
            </span>
            <Hint
            ...
            >
              <label>
                ...
                <span
                  ...
                  data-label-off={this.props.t("Выкл")}
  ...
  render() {
    ...
    console.log("this.state.serviceCurrent", this.state.serviceCurrent);
    console.log("this.state.appointment", this.state.appointment);
        ...
        <div className="new_appointment">
          <div>
            <div className="modal-content">
              ...
              <div
                className={`form-group form-group-addService ${isAddBookedService &&
                  "mb-0"}`}
              >
                <div className="row">
                      ...
                      <>
                            ...
                            <div className="pl-0 col-sm-8 col-11">
                              ...
                              <div className="dropdown add-staff p-2  border border-2 mb-3">
                                <a
                                  ...
                                  href="#"
                                >
                                  <span>{t("Выберите группу услуг")}</span>
                                </a>
                                <ul className="dropdown-menu">
                                  <li className="dropdown-item">
                                    <a>
                        ...
                        <div className="appointments-container ml-4 mr-sm-5 mr-lg-3">
                          <InputCounter
                            withCounter={true}
                            title={t("Заметка")}
                            placeholder={t("Клиент может опоздать")}
                            // value={}
                            name="markName"
                            // handleChange={() => {}}
                            maxLength={120}
                            ...
                            <div className="col-sm-12">
                              {isAddBookedService ? (
                                <>
                                  ...
                                  <p>
                                    {`${t(
                                      "Быстрый поиск или добавление клиента"
                                    )}:`}
                                  </p>
                                </>
                              ) : (
                                <>
                                  <p className="add-helpers-text mobile-visible">
                                    {companyTypeId === 4
                                      ? t("Добавление пациента")
                                      : t("Добавление клиента")}{" "}
                                    <Hint
                                      hintMessage={t(
                                        "Начните поиск. Если клиента нет в базе, заполните необходимые поля"
                                      )}
                                    />
                                  </p>
                            ...
                            <>
                              ...
                              <div className="mobileButton">
                                <button
                                  style={{ minWidth: "48%" }}
                                  className={
                                    "button text-center button-absolute"
                                  }
                                  type="button"
                                  onClick={() => {
                                    if (
  ...
  editAppointment() {
    ...
    const appointmentNew = appointment.map((item, i) => {
      return {
        ...
        duration: item.duration
          ? item.duration
          : this.getDurationForCurrentStaff(serviceCurrent[i].service),
    ...
    // } else {
    this.props.dispatch(
      calendarActions.editAppointment2(
