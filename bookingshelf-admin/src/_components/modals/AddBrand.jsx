...
class AddBrand extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <Modal size="xs" onClose={this.closeModal} showCloseButton={false} className="mod modal-brand">
          <div className="">
            {client &&
                        <div>
                          <div className="modal-content">
                            <div className="modal-header">
                              {!edit ? <h4 className="modal-title">{t("Новый бренд")}</h4>
                                : <h4 className="modal-title">{t("Редактирование бренда")}</h4>
                              }
                            ...
                            <div className="form-group mr-3 ml-3">
                              <div className="row">
                                <div className="col-sm-12">
                                  <InputCounter title={t("Название бренда")} placeholder={t("Например: БелКосметик")} value={client.brandName}
                              ...
                              <button className={(!client.brandName ? 'disabledField': '')+' button button-save'}
                                disabled={!client.brandName}
                                type="button"
                                onClick={client.brandName && (edit ? this.updateClient : this.addClient)}
                              >{t("Сохранить")}
                              </button>
                            </div>
                          </div>
  ...
  updateClient() {
    ...
    this.props.dispatch(materialActions.toggleBrand(client, true));
  };
  ...
  addClient() {
    ...
    this.props.dispatch(materialActions.toggleBrand(client));
  };
...
const connectedApp = connect(mapStateToProps)(withTranslation("common")(AddBrand));
export { connectedApp as AddBrand };
