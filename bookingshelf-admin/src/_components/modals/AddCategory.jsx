...
class AddCategory extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <Modal size="xs" onClose={this.closeModal} showCloseButton={false} className="mod modal-category">
          <div className="">
            {client &&
                        <div>
                          <div className="modal-content">
                            <div className="modal-header">
                              {!edit ? <h4 className="modal-title">{t("Новая категория")}</h4>
                                : <h4 className="modal-title">{t("Редактирование категории")}</h4>
                              }
                            ...
                            <div className="form-group mr-3 ml-3">
                              <div className="row">
                                <div className="col-sm-12">
                                  <InputCounter withCounter={true} title={t("Название категории")} placeholder={t("Например: Лаки")} value={client.categoryName}
                              ...
                              <button className={(!client.categoryName ? 'disabledField': '')+' button button-save'}
...
const connectedApp = connect(mapStateToProps)(withTranslation("common")(AddCategory));
