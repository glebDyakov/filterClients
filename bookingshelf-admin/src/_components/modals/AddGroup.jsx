...
class AddGroup extends React.Component {
    ...
    componentWillReceiveProps(newProps) {
        ...
        if ( JSON.stringify(this.props.group_workingGroup) !==  JSON.stringify(newProps.group_workingGroup)) {
            const {edit, group_workingGroup, newSet} = newProps;
            const {newGroup} = this.state;

            this.setState({edit:edit, newSet:newSet});

            if(edit){
                this.setState({group:group_workingGroup})
            } else {
    ...
    render() {
        ...
        return (
            ...
            <div className="modal fade modal_add_group" tabIndex="-1" role="dialog" aria-hidden="true">
    ...
    handleChangeColor(value) {
        ...
        this.setState({ group: {...group, color: value }});
    }

    toggleChange () {
        const { group } = this.state;

        this.setState({ group: {...group, acceptNewsletter: !group.acceptNewsletter }});
    }
...
AddGroup.propTypes ={
    group_workingGroup: PropTypes.object,
