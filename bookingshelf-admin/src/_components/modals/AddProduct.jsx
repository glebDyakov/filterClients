                      ...
                      <div className="modal-content">
                        <div className="modal-header">
                          {!edit ? <h4 className="modal-title">{t("Новый товар")}</h4>
                            : <h4 className="modal-title">{t("Редактирование товара")}</h4>
                          }
                        ...
                        <div className="form-group">
                          <div className="row main-info">
                            <div className="col-sm-8">
                              <InputCounter title={t("Наименование")} placeholder={t('Например Средний шампунь')}
                              ...
                              <div className="row">
                                ...
                                <div className="col-sm-4">
                                  <InputCounter title={t("Номинал объем")}
                                    placeholder={t("Введите номинальный объем")}
                                ...
                                <div className="col-sm-4">
                                  <InputCounter title={t("Код товара")} placeholder={t("Введите код")}
                          ...
                          <div className="row min-amount-and-description">
                            <div className="col-sm-4">
                              ...
                              <InputCounter title={t("Уведомление о низком остатке")}
                          ...
                          {material && material.status === 200 &&
                                <p className="alert-success p-1 rounded pl-3 mb-2 button">{t("Сохранено")}</p>
                          }
...
const connectedApp =  compose(connect(mapStateToProps), withRouter, withTranslation("common"))(AddProduct);
