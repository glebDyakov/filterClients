...
class AddProvider extends React.Component {
  ...
  render() {
    ...
    return (
      <Modal size="md" onClose={this.closeModal} showCloseButton={false} className="mod modal-supplier">
        <div className="">
          {client &&
                    <div>
                      <div className="modal-content">
                        <div className="modal-header">
                          {!edit ? <h4 className="modal-title">{t("Новый поставщик")}</h4>
                            : <h4 className="modal-title">{t("Редактирование поставщика")}</h4>
                          }
                        ...
                        <div className="form-group mx-3 mx-md-0">
                          ...
                          <div className="row">
                            <div className="col-sm-4">
                              <InputCounter title={t("Наименование")} placeholder={t('Например ООО Поставка Бест' )} value={client.supplierName}
                                name="supplierName" handleChange={this.handleChange} withCounter={true} maxLength={64} />

                              <InputCounter title={t("Веб-сайт")} placeholder="www.website.com" value={client.webSite}
                                name="webSite" handleChange={this.handleChange} withCounter={true} maxLength={128} />
                            </div>
                            <div className="col-sm-8">
                              <p>{t("Описание")}</p>
                              <textarea placeholder={t("Например Поставщик шампуней")} value={client.description}
                          ...
                          <div className="row address-block">
                            <p className="title mb-2 col-sm-12">{t("Адрес")}</p>
                            <div className="col-sm-4">
                              <p>{t("Страна")}</p>
                              ...
                              <InputCounter title={t("Город")} placeholder={t("Введите город")} value={client.city} name="city"
                                handleChange={this.handleChange} withCounter={true} maxLength={32} />
                            </div>
                            <div className="col-sm-4">
                              <InputCounter title={t("Улица")} placeholder={t("Введите улицу")} value={client.street}
                                name="street" handleChange={this.handleChange} withCounter={true} maxLength={64} />

                              <div className="row">
                                <div className="col-sm-6">
                                  <InputCounter title={t("Здание, офис")} placeholder={t("Дом 205")} value={client.office}
                                    name="office" withCounter={true} handleChange={this.handleChange} maxLength={32} />
                                </div>
                                <div className="col-sm-6">
                                  <InputCounter title={t("Почтовый код")} placeholder={t("Введите код")} value={client.zipCode}
                          ...
                          <div className="contacts-block">
                            <p className="title mb-2">{t("Контакты")}</p>
                            {client.contactPersons && client.contactPersons.map((contactPerson, index) =>
                              <React.Fragment>
                                {(client.contactPersons.length > 1) && <p>{t("Контакт")} {index + 1}</p>}
                                <div className="row position-relative">
                                  <div className="col-sm-8">
                                    <div className="row">
                                      <div className="col-sm-6 first-name">
                                        <InputCounter title={t("Имя")} placeholder="" value={contactPerson.firstName}
                        ...
                        <div className="button-save-block col-sm-12">
                          <p className="mb-2 add-contact"
                            onClick={() => {
                              const updatedClient = { ...client };
...
const connectedApp = connect(mapStateToProps)(withTranslation("common")(AddProvider));
