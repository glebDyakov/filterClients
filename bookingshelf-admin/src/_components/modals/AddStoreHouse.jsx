...
class AddStoreHouse extends React.Component {
  constructor(props) {
    super(props);
    let client;
  ...
  render() {
    ...
    return (
      <div>
        <Modal size="xs" onClose={this.closeModal} showCloseButton={false} className="mod modal-storehouse">
          <div className="">
            {client &&
                        <div>
                          <div className="modal-content">
                            <div className="modal-header">
                              {!edit ? <h4 className="modal-title">{t("Новый склад")}</h4>
                                : <h4 className="modal-title">{t("Редактирование склада")}</h4>
                              }
                            ...
                            <div className="form-group mr-3 ml-3">
                              <div className="row">
                                <div className="col-sm-12">
                                  <InputCounter withCounter={true} title={t("Название склада")} placeholder={t("Например склад Ашан на ул.Горького 19")} value={client.storehouseName}
                              ...
                              <button className={(!client.storehouseName ? 'disabledField': '')+' button button-save'}
                                disabled={!client.storehouseName}
                                type="button"
                                onClick={client.storehouseName && (edit ? this.updateClient : this.addClient)}
                              >{t("Сохранить")}
                              </button>
                            </div>
                          </div>
  ...
  updateClient() {
    ...
    this.props.dispatch(materialActions.toggleStoreHouse(client, true));
  };
  ...
  addClient() {
    ...
    this.props.dispatch(materialActions.toggleStoreHouse(client));
  };
...
const connectedApp = connect(mapStateToProps)(withTranslation("common")(AddStoreHouse));
export { connectedApp as AddStoreHouse };
