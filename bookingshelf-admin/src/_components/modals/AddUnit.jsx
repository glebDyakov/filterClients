...
class AddUnit extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <Modal size="xs" onClose={this.closeModal} showCloseButton={false} className="mod modal-unit">
          <div className="">
            {client &&
                        <div>
                          <div className="modal-content">
                            <div className="modal-header">
                              {!edit ? <h4 className="modal-title">{t("Новая единица измерения")}</h4>
                                : <h4 className="modal-title">{t("Редактирование единицы измерения")}</h4>
                              }
                            ...
                            <div className="form-group mr-3 ml-3">
                              <div className="row">
                                <div className="col-sm-12">
                                  <InputCounter title={t("Название единицы измерения")} placeholder={t("Например литры")} value={client.unitName}
                              ...
                              <button
                                className={(!client.unitName ? 'disabledField': '')+' button button-save'}
                                disabled={!client.unitName}
                                type="button"
...
const connectedApp = connect(mapStateToProps)(withTranslation("common")(AddUnit));
export { connectedApp as AddUnit };
