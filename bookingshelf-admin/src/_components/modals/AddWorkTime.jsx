          ...
          <div className="">
            <div className="modal-content">
              <div className="modal-header">
                <p
                  className="modal-title">{!editWorkingHours ? t('Добавить часы работы') : t('Изменить рабочие часы')}</p>
                ...
                <div className="form-group">
                  <div className="mr-3 ml-3">
                    ...
                    {countTimes && countTimes.map((item, key) =>
                      <div key={key} className="time-element border-bottom mb-2">
                        <span className="remove-time"
                              onClick={() => this.onRemoveTime(key)}>{t('Удалить')}</span>
                    ...
                    {countTimes.length <= 5 && <a className="add-work-time"
                                                  onClick={() => this.onAddTime()}>{t('Добавить часы работы')} +</a>
                    }
