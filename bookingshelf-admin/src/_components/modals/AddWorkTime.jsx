                            ...
                            <div className="form-group">
                                ...
                                <div className="form-group mr-3 ml-3">
                                    ...
                                    <div className="buttons">
                                        {editWorkingHours && <button className="small-button red-button" style={{marginRight: '10px'}} type="button" onClick={() => this.onDelete(moment(date, 'DD/MM').startOf('day').format('x'), moment(date, 'DD/MM').endOf('day').format('x'))} data-dismiss="modal">Удалить</button>}
