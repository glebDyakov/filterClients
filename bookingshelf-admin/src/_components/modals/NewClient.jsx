                    ...
                    <div className="modal-content">
                        ...
                        <div className="form-group">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-4">
                                    <InputCounter title="Фамилия" placeholder="Введите фамилию" value={client.lastName}
                                ...
                                <div className="col-sm-4">
                                    <InputCounter title="Отчество" placeholder="Введите отчество" value={client.middleName}
                                                  name="middleName"  handleChange={this.handleChange} maxLength={128} />

                                    <p>День рождения</p>
                                    <div className="birthday-date-container" style={{ display: 'flex', justifyContent: 'center' }}>
                                        <select className="custom-select" onChange={this.handleBirthdayChange} name="day" value={day}>
                                            <option value={''}>День</option>
                                            {this.getDayOptionList()}
                                        </select>

                                        <select className="custom-select" onChange={this.handleBirthdayChange} name="month" value={month}>
                            ...
                            <div className="row">
                                <div className="col-sm-4">
                                    <InputCounter title="Страна" placeholder="Введите страну" value={client.country}
                                                  name="country" handleChange={this.handleChange} maxLength={128} />
                                    <InputCounter title="Область" placeholder="Введите область" value={client.province}
                                ...
                                <div className="col-sm-4">
                                    ...
                                    <InputCounter title="Адрес" placeholder="Введите адрес" value={client.address}
                            ...
                            <div className="row">
                                <div className="col-sm-4">
                                    ...
                                    <input type="text" value={client.discountPercent} placeholder="Введитете процент скидки" step="1" min="1" max="100" name="discountPercent"
                            ...
                            <div className="row">
                                <div className="col-sm-4">
                                    <InputCounter title="Vk" placeholder="Введите VK" value={client.vk} name="vk"
                                                  handleChange={this.handleChange} maxLength={128} />

                                    <InputCounter title="Facebook" placeholder="Введите Facebook" value={client.facebook} name="facebook"
                                                  handleChange={this.handleChange} maxLength={128} />
                                ...
                                <div className="col-sm-4">
                                    <InputCounter title="Instagram" placeholder="Введите Instagram" value={client.instagram} name="instagram"
                                                  handleChange={this.handleChange} maxLength={128} />

                                    <InputCounter title="Tik Tok" placeholder="Введите Tik Tok" value={client.tiktok} name="tiktok"
                                                  handleChange={this.handleChange} maxLength={128} />
