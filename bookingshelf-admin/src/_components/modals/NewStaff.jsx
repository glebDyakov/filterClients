...
если доступ не нужен`} />
                                                    ...
                                                    <div className="row">
                                                        <div className="col-md-6">
                                                           ...
                                                           <Select
                                                            ...
                                                            {/*        id={staff.staffId}*/}
                                                            {/*        showOutsideDays*/}
                                                            {/*        selectedDays={staff.workStartMilis ? moment(staff.workStartMilis, 'x').startOf('day').toDate() : moment().toDate()}*/}
                                                            {/*        onDayClick={!edit && this.handleDayClick}*/}
                                                            {/*        localeUtils={MomentLocaleUtils}*/}
                                                            {/*        locale={'ru'}*/}
                                                            {/*        canChangeMonth={!edit}*/}
                                                            {/*        disabledDays={edit ? [*/}
                                                            {/*            {*/}
                                                            {/*                after: moment(staff.workStartMilis, 'x').startOf('day').toDate(),*/}
                                                            {/*                before: moment(staff.workStartMilis, 'x').startOf('day').toDate(),*/}
                                                            {/*            }*/}
                                                            {/*        ]:{*/}
                                                            {/*            after: new Date(1995, 3, 20),*/}
                                                            {/*            before: new Date(2010, 3, 25),*/}
                                                            {/*        }}*/}
                                                            {/*        month={staff.workStartMilis ?*/}
                                                            {/*            new Date(parseInt(moment(staff.workStartMilis, 'x').format('YYYY')), parseInt(moment(staff.workStartMilis, 'x').format('M'))-1):*/}
                                                            {/*            new Date(parseInt(moment().format('YYYY')), parseInt(moment().format('M'))-1)*/}
                                                        ...
                                                        <div className="col-md-12">
                                                                        ...
                                                                        <label className="drop_target">
                                                                            ...
                                                                            <div className="image_preview">
                                                                                <div className="existed-image">
                                                                                    <img src={staff.imageBase64 && staff.imageBase64!==''?("data:image/png;base64,"+staff.imageBase64):`${process.env.CONTEXT}public/img/image.png`}/>
                                                            ...
                                                            <div className="buttons new-staff-buttons">
                                                                <button className="small-button cancel-button"
    ...
    handleDayClick(day, { selected }) {
        ...
        let daySelected = selected ? moment().format('x') : moment(day).format('x');
