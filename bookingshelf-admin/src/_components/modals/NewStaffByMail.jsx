...
class NewStaffByMail extends React.Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <Modal size="md" style={{ maxWidth: 'fit-content' }} onClose={this.closeModal} showCloseButton={false}
          className="mod">
  ...
  addStaffEmail() {
    this.props.addStaffEmail(this.state.emailNew);
  }
