...
class ReservedTime extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            reservedTime: props.reservedTime!=null ? props.reservedTime :{
                startTimeMillis:'',
                endTimeMillis:'',
                description:""
            },
    ...
    render() {
        ...
        return (
            <div className="modal fade modal_calendar" tabIndex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-inner pl-4 pr-4 pb-4">
                            ...
                            <div className="buttons">
                                <button className="small-button gray-button" type="button">Отменить</button>

                                <button className={(calendar.adding || !staffCurrent.staffId || !reservedTime.endTimeMillis || !reservedTime.startTimeMillis) ? 'small-button disabledField': 'small-button'} type="button"
                                        onClick={staffCurrent.staffId && reservedTime.endTimeMillis && reservedTime.startTimeMillis && this.addReservedTime} disabled={calendar.adding || !staffCurrent.staffId || !reservedTime.endTimeMillis || !reservedTime.startTimeMillis}
                                >Сохранить</button>
                            </div>
                        </div>
                    </div>
