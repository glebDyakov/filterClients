...
class StorehouseProduct extends React.Component {
  constructor(props) {
    super(props);
    let client;
    ...
    this.storehouseProduct = this.storehouseProduct.bind(this);
  }
  ...
  render() {
    ...
    return (
        <div>
          <Modal size="xs" onClose={this.closeModal} showCloseButton={false} className="mod modal-add-products">
            <div className="">
              {client &&
              <div>
                <div className="modal-content">
                  ...
                  <div className="form-group">
                    ...
                    <div className="row">
                      <div className="col-sm-12">
                        <InputCounter withCounter={true} title={t(`Количество товара на пополнение, единиц`)} value={String(client.amount ? client.amount : '')}
                    ...
                    <div className="row">
                      <div className="col-sm-12">
                        <div className="row">
                          <div className="col-sm-12">
                            <InputCounter withCounter={true} title={t("Розничная цена")} placeholder={t("Введите цену")} value={String(client.retailPrice ? client.retailPrice : '')}
                                          name="retailPrice" handleChange={this.handleChange} maxLength={9} />
                          </div>
                          <div className="col-sm-12">
                            <InputCounter withCounter={true} title={t("Специальная цена")} placeholder={t("Введите цену")} value={String(client.specialPrice ? client.specialPrice : '')}
                    ...
                    <button className={(!(client.amount && client.supplierId) ? 'disabledField': '')+' button button-save'}

                            disabled={!(client.amount && client.supplierId)}
...
const connectedApp = connect(mapStateToProps)(withTranslation("common")(StorehouseProduct));
export { connectedApp as StorehouseProduct };
