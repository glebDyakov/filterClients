                ...
                <div className="modal-dialog add-work-time-modal">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h4 className="modal-title">{this.props.edit ? t('Редактировать часы работы') : t('Добавить часы работы')}</h4>
                        ...
                        <div className="form-group d-flex">
                            ...
                            <div className="modal-body">
                                ...
                                <div className="container-fluid work-time-container col-12 col-md-12">
                                    <h2 className="work-time-title">{t('Повтор')}</h2>
                                    <div className="check-box repeat">
                                        ...
                                        <div className="form-check-inline">
                                            ...
                                            />
                                            <label className="form-check-label"
                                                   htmlFor="radio106">{t('1 через 1')}</label>
                                            <Hint
                                                hintMessage={
                                                    t('Начиная с выбранного дня')
                                                }
                                            />
                                        ...
                                        <div className="form-check-inline">
                                            ...
                                            <label className="form-check-label"
                                                   htmlFor="radio105">{t('2 через 2')}</label>
                                            <Hint
                                                hintMessage={
                                                    t('Начиная с выбранного дня')
                                                }
                                    ...
                                    <div className="inline-group d-flex">
                                        ...
                                        <div className="gap w-100">
                                            <h2 className="work-time-title">{t('Интервал')}</h2>
                                            {this.state.countTimes.map((item, key) => {
                                                return (
                                                    <div
                                                        ...
                                                        }} className="delete-gap">{t('Удалить интервал')}</a>
                                            ...
                                            <a onClick={this.onAddTime}
                                               className="add-work-time">{t('Добавить интервал +')}</a>}
                                        </div>
                                    </div>
                                    <div className="button-container text-center text-md-right">
                                        ...
                                        <button onClick={this.props.onClose} className="cancel">{t('Отменить')}</button>
                                        <button
