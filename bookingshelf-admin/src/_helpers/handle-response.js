...
export const hostname = (location.hostname === 'localhost') ? 'test.admin.online-zapis.com' : location.hostname;

export const origin = (location.hostname === 'localhost') ? 'https://test.admin.online-zapis.com' : location.origin;
