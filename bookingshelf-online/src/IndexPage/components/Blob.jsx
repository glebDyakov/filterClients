            ...
            <MediaQuery minWidth={810}>
                <div className="blob">
                    <svg width="1264" height="900" viewBox="0 0 1264 900" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.1" fill-rule="evenodd" clip-rule="evenodd" d="M1143.64 220.869C1195.31 370.447 1209.57 553.565 1093.41 673.327C983.667 786.473 800.137 731.626 640.019 740.094C479.911 748.562 286.877 833.591 184.873 721.379C82.9174 609.219 181.658 437.705 234.789 294.308C276.18 182.596 338.722 82.7131 445.338 18.3965C565.13 -53.8682 704.605 -107.368 837.003 -68.9788C983.992 -26.3593 1096.23 83.6147 1143.64 220.869Z" fill="var(--color_button)" />
                    </svg>
                </div>
            </MediaQuery>
        )
            ...
            <MediaQuery minWidth={810}>
                <div className="blob">
                    <svg width="1306" height="900" viewBox="0 0 1306 900" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.1" fill-rule="evenodd" clip-rule="evenodd" d="M428.029 129.343C552.687 61.9373 683.873 1.89448 809.948 21.9132C951.2 44.3418 1077.71 114.972 1113.32 238.157C1149.61 363.668 1077.94 505.913 986.032 631.031C888.073 764.391 765.822 912.4 601.892 934.414C441.917 955.898 354.373 825.487 259.325 728.621C170.076 637.666 51.0252 546.71 89.0218 411.736C126.477 278.687 291.025 203.424 428.029 129.343Z" fill="var(--color_button)" />
                    </svg>
                </div>
            </MediaQuery>
        )
