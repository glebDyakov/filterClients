                    ...
                    <React.Fragment>
                        <div className="row align-items-center content clients mb-2 search-block">
                            <div className="search col-12">
                                <img style={{position: 'absolute', left: '20px'}}
                                     src={`${process.env.CONTEXT}public/img/search-icon.svg`}/>
                                <input style={{margin: 0, paddingLeft: '38px'}} type="search"
                                       placeholder={t("Введите название услуги или категории")}
                                                ...
                                                >
                                                    <div className="service_item">
                                                        <label>
                                                            ...
                                                            <span
                                                                className="runtime"><strong>{moment.duration(parseInt(getDurationForCurrentStaff(service)), "seconds").format(`h[ ${t("ч")}] m[ ${t("минут")}]`)}</strong></span>
